...
- ARQ en ventana deslizante con rechazo simple
	...
	- El receptor recibe las tramas:
		- Si se pierde alguna trama o se des
	- El receptor envía la confirmación de la trama `n`
		- El emisor da por confirmadas todas las tramas anteriores a `n`.
	- El receptor recibe una trama que no espera (desordenada):
		- Pide al emisor que reenvíe la trama 
